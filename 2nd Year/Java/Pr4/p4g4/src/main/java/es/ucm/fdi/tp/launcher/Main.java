...
public class Main {
	...
	/**
	 * Se crea el estod inicial del juego.
	 ...
	 */
	public static GameState<?,?> createInitialState(String gameName) throws IllegalArgumentException{
	 ...
	 */
	public static GamePlayer createPlayer (String gameName, String playerType, String playerName)throws IllegalArgumentException{
		if (playerType.equalsIgnoreCase("RAND")) return new RandomPlayer(playerName);
		else if (playerType.equalsIgnoreCase("SMART")) return new SmartPlayer(playerName,15);
